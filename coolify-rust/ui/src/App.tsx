            ...
            <>
              {currentTab === 'dashboard' && (
                <DashboardPage
                  ...
                  onGoToServers={() => setCurrentTab('servers')}
                />
              )}
              ...
              {currentTab === 'servers' && <ServersPage />}
              ...
              {currentTab === 'settings' && (
                <div className="bg-[#18181b] border border-[#27272a] p-12 rounded-xl text-center space-y-3">
                  <h2 className="text-xl font-bold text-white">Coolify Instance Settings</h2>
                  <p className="text-xs text-zinc-400">Configure global domains, auto-updates, and SSL proxies.</p>
                </div>
              )}
            </>
          )}
