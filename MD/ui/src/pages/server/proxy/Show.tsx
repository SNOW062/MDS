...
import { NewDynamicConfiguration } from './NewDynamicConfiguration';
...
export const Show: React.FC = () => {
  ...
  return (
    <div className="space-y-6 w-full animate-in fade-in duration-100">
      ...
      {/* Modals */}
      <Logs isOpen={isLogsOpen} onClose={() => setIsLogsOpen(false)} />
      <NewDynamicConfiguration isOpen={isNewConfigOpen} onClose={() => setIsNewConfigOpen(false)} />
    </div>
  );
};
