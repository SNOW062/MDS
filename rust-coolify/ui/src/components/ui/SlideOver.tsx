...
export default function SlideOver({ isOpen, onClose, title, children }: SlideOverProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="w-96 bg-[var(--bg-secondary)] border-l border-[var(--border-color)] h-full p-6 shadow-2xl relative z-10 flex flex-col justify-between animate-slide-left">
        <div>
