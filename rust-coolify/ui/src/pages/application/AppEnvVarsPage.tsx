  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">Environment Variables</h1>
      </div>
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6 space-y-4">
        <div className="flex justify-between items-center">
          <h2 className="text-sm font-bold text-[var(--text-primary)]">Variables</h2>
          <button className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--bg-tertiary)] hover:bg-[#3f3f46] text-xs text-white rounded-lg transition-colors">
            <Plus className="h-3.5 w-3.5" /> Add
          </button>
        </div>
        <div className="space-y-2">
          <div className="flex gap-3">
            <input className="w-1/3 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded px-3 py-1.5 text-xs text-white" value="PORT" readOnly />
            <input className="flex-1 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded px-3 py-1.5 text-xs text-white" value="3000" readOnly />
          </div>
        </div>
      </div>
    </div>
