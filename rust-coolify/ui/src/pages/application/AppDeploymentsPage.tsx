  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4 border-b border-[#27272a] pb-px">
        ...
        <Link to={`/projects/${uuid}/${env_uuid}/app/${app_uuid}/deployments`} className="px-4 py-2 border-b-2 border-indigo-500 text-xs font-semibold text-indigo-400">
          Deployments
        </Link>
      ...
      <div className="bg-[#18181b] border border-[#27272a] rounded-xl p-6">
        <p className="text-xs text-zinc-500">Heç bir yığılma loqu yoxdur.</p>
      </div>
    </div>
  );
}