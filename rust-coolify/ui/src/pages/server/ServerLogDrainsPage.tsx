  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">Log Drains</h1>
      </div>
      ...
      {/* Main Containers */}
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6 space-y-8">
        ...
        <div className="border border-[var(--border-color)] rounded-lg p-4 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-xs font-bold text-[var(--text-primary)]">New Relic</h3>
            ...
            <div className="space-y-4 pt-2 border-t border-[var(--border-color)]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-[var(--text-secondary)]">License Key</label>
                  <input
                    type="password"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-[var(--text-secondary)]">Endpoint</label>
                  <input
                    type="text"
        ...
        <div className="border border-[var(--border-color)] rounded-lg p-4 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-xs font-bold text-[var(--text-primary)]">Axiom</h3>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
          ...
          {isLogDrainAxiomEnabled && (
            <div className="space-y-4 pt-2 border-t border-[var(--border-color)]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-[var(--text-secondary)]">Dataset Name</label>
                  <input
                    type="text"
        ...
        <div className="border border-[var(--border-color)] rounded-lg p-4 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-xs font-bold text-[var(--text-primary)]">Custom FluentBit</h3>
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
          ...
          {isLogDrainCustomEnabled && (
            <div className="space-y-4 pt-2 border-t border-[var(--border-color)]">
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-[var(--text-secondary)]">Custom FluentBit Configuration</label>
                  <textarea
                    value={logDrainCustomConfig}
                    onChange={(e) => setLogDrainCustomConfig(e.target.value)}
                    rows={6}
                    className="w-full bg-[#09090b] border border-[var(--border-color)] rounded-lg p-3 font-mono text-xs text-zinc-300 focus:outline-none focus:border-indigo-500"
                  />
                </div>
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-[var(--text-secondary)]">Custom Parser Configuration</label>
                  <textarea
