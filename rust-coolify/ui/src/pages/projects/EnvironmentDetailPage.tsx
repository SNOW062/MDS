        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-[var(--text-primary)]">{t.projects.applications}</h3>
            </div>
            <button className="p-1 rounded bg-[var(--bg-tertiary)] hover:bg-[#3f3f46] text-[var(--text-secondary)] transition-colors">
          ...
          {env.applications?.map(app => (
            <div
              ...
              className="p-3 bg-[var(--bg-tertiary)]/40 border border-[var(--border-color)]/30 rounded-lg hover:border-zinc-500 cursor-pointer transition-colors"
            >
        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-[var(--text-primary)]">{t.projects.databases}</h3>
            </div>
            <button className="p-1 rounded bg-[var(--bg-tertiary)] hover:bg-[#3f3f46] text-[var(--text-secondary)] transition-colors">
              <Plus className="h-3.5 w-3.5" />
            </button>
          ...
          {env.postgresqls?.map(db => (
            <div
              ...
              className="p-3 bg-[var(--bg-tertiary)]/40 border border-[var(--border-color)]/30 rounded-lg hover:border-zinc-500 cursor-pointer transition-colors"
            >
              <p className="text-xs font-bold text-[var(--text-primary)]">{db.name}</p>
        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-6">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-[var(--text-primary)]">{t.projects.services}</h3>
            </div>
            <button className="p-1 rounded bg-[var(--bg-tertiary)] hover:bg-[#3f3f46] text-[var(--text-secondary)] transition-colors">
              <Plus className="h-3.5 w-3.5" />
            </button>
