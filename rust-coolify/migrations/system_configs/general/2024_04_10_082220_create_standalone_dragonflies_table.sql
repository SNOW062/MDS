-- completed mig_159
-- Converted from: 2024_04_10_082220_create_standalone_dragonflies_table.php

CREATE TABLE IF NOT EXISTS standalone_dragonflies (
    uuid VARCHAR(255),
    name VARCHAR(255),
    description VARCHAR(255),
    dragonfly_password TEXT,
    ...
    standalone_dragonfly_id BIGINT,
    standalone_dragonfly_id TEXT
);

-- ALTER TABLE environment_variables
-- Review 2024_04_10_082220_create_standalone_dragonflies_table.php for specific alterations
...
ALTER TABLE environment_variables ADD COLUMN IF NOT EXISTS dragonfly_password TEXT;
...
ALTER TABLE environment_variables ADD COLUMN IF NOT EXISTS standalone_dragonfly_id TEXT;
...
DROP TABLE IF EXISTS standalone_dragonflies;
