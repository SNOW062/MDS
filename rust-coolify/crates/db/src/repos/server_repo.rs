...
pub async fn create_server(
    ...
    let server = sqlx::query_as::<_, Server>(
        "INSERT INTO servers (id, team_id, name, ip, port, "user", is_reachable, is_build_server, proxy_type, sentinel_enabled, sentinel_metrics_refresh_rate, sentinel_metrics_history_days, sentinel_push_interval, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, true, false, 'none', false, 5, 7, 60, NOW(), NOW()) RETURNING *"
    )
    .bind(Uuid::new_v4())
    .bind(team_id)
    .bind(name)
